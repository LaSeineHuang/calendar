...
public class LunarCalender {
    private static final int[] LUNAR_INFO = {
            ...
            0x04afb, 0x04970, 0x064b0, 0x074a3, 0x0ea50, 0x06b58, 0x05ac0, 0x0ab60, 0x096d5, 0x092e0, // 1990-1999
    ...
    public static Calendar lunarToSolar(int lunarYear, int lunarMonth, int lunarDay, boolean isLeapMonth) {
        ...
        for (int i = 1; i < lunarMonth; i++) {
            if (leap > 0 && i == (leap + 1) && !leapMonthFlag) {
                --i;
                leapMonthFlag = true;
